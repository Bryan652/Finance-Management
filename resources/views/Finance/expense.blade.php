<x-layout>
    <x-slot:heading>
        <h1 class="text-3xl font-extrabold text-blue-800 mb-6">Expense Creation</h1>
    </x-slot:heading>
    ...
    <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-12">
            <h2 class="text-base/7 font-semibold text-gray-900">Expense</h2>
            <p class="mt-1 text-sm/6 text-gray-600">Expense Expense Expense Expense</p>
