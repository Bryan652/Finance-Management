        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/finance" :active="request()->is('finance')">Finance</x-nav-link>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Bryan Dela Cruz</div>
            <div class="text-sm font-medium text-gray-400">Bryandelacruz901@gmail.com</div>
          </div>
